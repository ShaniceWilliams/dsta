...
4. if the second person wasn't there, *body-color=gray* would split off a pure, single-datapoint segment. Is it desirable? (see last slide)
...
$Pr[\textrm{Play}_6='No']=\frac{3}{4}$, $Pr[\textrm{Play}_6='Yes']=\frac{1}{4}.$
